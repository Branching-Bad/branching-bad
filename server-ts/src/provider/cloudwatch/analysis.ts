// ---------------------------------------------------------------------------
// CloudWatch Analysis — runAnalysis, buildTaskDescription
// ---------------------------------------------------------------------------
...
export async function runAnalysis(
  ...
  const prompt = `You are analyzing CloudWatch logs for this user question:
"${question}"
...
export function buildTaskDescription(
  ...
  let desc = `## CloudWatch Investigation\n\n**Question:** ${question}\n\n`;
