...
export const WorkflowCanvas: FC<Props> = ({
  ...
  useEffect(() => {
    ...
    orderEnter.append('circle').attr('r', 8).attr('fill', CANVAS.brand).attr('stroke', CANVAS.surface100).attr('stroke-width', 1.5);
    ...
    merged
      .select('rect.bg')
      .attr('stroke', (d) =>
        d.id === selectedNodeId ? CANVAS.brand : CANVAS.borderStrong,
      )
